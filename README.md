...
- Using functions in the wild
- Working on iterative tasks
- Debugging code


### Data

The United Nations General Assembly Voting Data, accessible via [unvotes](https://github.com/dgrtwo/unvotes).
